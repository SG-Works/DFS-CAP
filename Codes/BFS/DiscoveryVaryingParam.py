	  ...
	  for T in Tlist:
      		...
      		for freq in freqlist:
          	  ...
          	  for exp in explist:
           		...
           		opfile = "%s/freq-%d-BE-%.2f-exp-%.3f" % (directory,freq,BE,exp)                                                                     
                        logfile = "%s/%d-%.2f-%.3f.log" % (directory,freq,BE,exp)
                        fin = open(logfile,'w')
                        ...
                        print 'Mining Parameters : freqThresh = %d, entTresh = %.2f, expTime = %.3f' % (freq,BE,exp)
